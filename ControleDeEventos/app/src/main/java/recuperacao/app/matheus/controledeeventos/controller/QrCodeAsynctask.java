 ...
 */
public class QrCodeAsynctask extends AsyncTask<String, Void, Response> {


    private PesquisaCallBack mCallBack;

    public QrCodeAsynctask(PesquisaCallBack mCallBack) {
    ...
    protected Response doInBackground(String... json) {
        ...
        try {
            ...
            response = HttpService.sendPostRequest(auxJSON);
